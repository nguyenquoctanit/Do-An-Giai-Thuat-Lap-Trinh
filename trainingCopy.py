        ...
        while True:
            ...
            if hour ==  choose_hour:
                ...
                if values['input_weight8'] != '':
                    program_dir8 = [ dir_py8, ' --img ', '416' , ' --batch ', '1' ,' --epochs ', '{}'.format(int(values['input_epoch8'])) , ' --data ', dir_data8 , ' --cfg ', dir_model8, ' --weights ', '{}'.format(weight_before), ' --name ', 'my_results' + '{}'.format(name_folder),  ' --cache']
                else:
                    program_dir8 = [ dir_py8, ' --img ', '416' , ' --batch ', '1' ,' --epochs ', '{}'.format(int(values['input_epoch8'])) , ' --data ', dir_data8 , ' --cfg ', dir_model8, ' --weights ', '""' , ' --name ', 'my_results' + '{}'.format(name_folder),  ' --cache']
